========================================================================
    KONSOLENANWENDUNG: UntrustedPerformanceTests-Projektübersicht
========================================================================

Diese UntrustedPerformanceTests-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre UntrustedPerformanceTests-Anwendung besteht.


UntrustedPerformanceTests.vcxproj
...
UntrustedPerformanceTests.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen UntrustedPerformanceTests.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
