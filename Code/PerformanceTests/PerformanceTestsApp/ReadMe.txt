========================================================================
    KONSOLENANWENDUNG: PerformanceTestsApp-Projektübersicht
========================================================================

Diese PerformanceTestsApp-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre PerformanceTestsApp-Anwendung besteht.


PerformanceTestsApp.vcxproj
...
PerformanceTestsApp.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen PerformanceTestsApp.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
