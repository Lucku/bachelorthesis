========================================================================
    STATISCHE BIBLIOTHEK: BenchmarkLib-Projektübersicht
========================================================================

Dieses BenchmarkLib-Bibliotheksprojekt wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre BenchmarkLib-Anwendung besteht.


BenchmarkLib.vcxproj
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen BenchmarkLib.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
