...
int main()
{
	...
	b->registerFunctionWithPreprocessing(ecall(eid, enclaveVByteDecode, MULT(4)), MULT(4), ecall(eid, enclaveVByteEncode, MULT(5)), DIVMULT(4, 5), "decompression", 1);
	...
	b->registerFunction(ecall(eid, enclaveVByte, DIVMULT(4, 5)), DIVMULT(4, 5), "vbyte", 4);
